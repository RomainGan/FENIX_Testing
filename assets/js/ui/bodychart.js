  ...
  return `<div class="inj-form" id="injFormBlock">
    ...
    <div class="inj-form-grid">
      <div>
        ...
        <div style="display:flex;gap:4px" id="injDateWrap">
          <select id="injDateJ" style="background:rgba(0,0,0,.3);border:1px solid var(--border-2);border-radius:6px;padding:8px 6px;color:var(--text);font-family:'Barlow',sans-serif;font-size:12px;box-sizing:border-box;flex:1" onchange="syncInjDate()">
          ...
          <select id="injDateM" style="background:rgba(0,0,0,.3);border:1px solid var(--border-2);border-radius:6px;padding:8px 6px;color:var(--text);font-family:'Barlow',sans-serif;font-size:12px;box-sizing:border-box;flex:2" onchange="syncInjDate()">
          ...
          <select id="injDateA" style="background:rgba(0,0,0,.3);border:1px solid var(--border-2);border-radius:6px;padding:8px 6px;color:var(--text);font-family:'Barlow',sans-serif;font-size:12px;box-sizing:border-box;flex:2" onchange="syncInjDate()">
...
// ─── DATE LÉSION HELPER ───────────────────────────────────
function syncInjDate(){
  const j=document.getElementById('injDateJ')?.value||'';
...
function setInjDateFields(dateStr){
  ...
  const jEl=document.getElementById('injDateJ');
  const mEl=document.getElementById('injDateM');
  const aEl=document.getElementById('injDateA');
  if(jEl) jEl.value=parts[2];
